...
@Component
@Slf4j
public class AadharNumberValidatorForCreate implements Validator<IndividualBulkRequest, Individual> {

    private final IndividualProperties properties;

    @Autowired
    public AadharNumberValidatorForCreate(IndividualProperties properties) {
        this.properties = properties;
    }

    @Override
    public Map<Individual, List<Error>> validate(IndividualBulkRequest request) {
        log.info("validating aadhaarNumber for create");
