package org.egov.platform.localization.web.controller;

import jakarta.validation.Valid;
import jakarta.validation.constraints.Size;
import org.egov.platform.localization.domain.model.MessageRequest;
...
import org.egov.platform.localization.web.contract.*;
import org.egov.platform.localization.web.exception.InvalidMessageRequest;
...
public class MessageController {
	...
	public MessagesResponse getMessages(@RequestParam("locale") String locale,
		...
		List<org.egov.platform.localization.domain.model.Message> domainMessages = messageService.getFilteredMessages(searchCriteria);
	...
	public MessagesResponse getMessages(@RequestBody MessageRequest messageRequest) {
		...
		List<org.egov.platform.localization.domain.model.Message> domainMessages = messageService.getFilteredMessages(messageRequest.getMessageSearchCriteria());
		return createResponse(domainMessages);
	}
	...
	public MessagesResponse upsertMessages(@Valid @RequestBody CreateMessagesRequest messageRequest,
		...
		final List<org.egov.platform.localization.domain.model.Message> messages = messageRequest.toDomainMessages();
	...
	private MessagesResponse createResponse(List<org.egov.platform.localization.domain.model.Message> domainMessages) {
